...
![Zustand](https://img.shields.io/badge/Zustand-18181B?style=flat-square&logo=zustand&logoColor=white)
...
|------------------|------------------------------------|--------------------------------|--------------------------------------------------------------------------------|
| Nov 2025 – present      | 🧑‍🏫 Software Engineer   | Gold Kinen Technologies Ltd       | Developed a full-featured reporting dashboard using Next.js 14 (App Router), enabling dynamic filtering, advanced tab navigation, and dual-mode views (detailed & summary). Implemented robust data management with React Query, including caching, background refetching, URL-state persistence, and error handling for a seamless UX.|
